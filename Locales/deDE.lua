...
function Return_deDE() 
  return {
    ...
    ["tt_ItemSetButton"] = "Klicke um ein Popup zu \195\182ffnen in welchem du Itemsets suchen kannst und deine Favoriten verwalten kannst.",
    ...
    ["tt_QuestButton"] = "Klicke um ein Popup zu \195\182ffnen in dem du Quests suchen kannst und deine Favoriten verwalten kannst.",
    ["tt_CreatureButton"] = "Klicke um ein Popup zu \195\182ffnen in dem du Kreaturen suchen kannst und deine Favoriten verwalten kannst.",
    ["tt_ObjectButton"] = "Klicke um ein Popup zu \195\182ffnen in dem du Objekte suchen kannst und deine Favoriten verwalten kannst.",
    ...
    ["ma_FavAdd"] = "Zuf\195\188gen ausgew\195\164hlt",
    ["ma_FavRemove"] = "L\195\182schen ausgew\195\164hlt",
    ["ma_SelectAllButton"] = "Alles markieren",
    ["ma_DeselectAllButton"] = "Alles demarkieren",
    ["ma_MailBytesLeft"] = "Noch fehlende Bytes: ",
    ["ma_WeatherFine"] = "Sch\195\182n",
    ["ma_WeatherFog"] = "Nebel",
    ["ma_WeatherRain"] = "Regen",
    ["ma_WeatherSnow"] = "Schnee",
    ["ma_WeatherSand"] = "Sandsturm",
    ["ma_LevelUp"] = "Level erh\195\182hen",
    ["ma_LevelDown"] = "Level verringern",
    ["ma_Money"] = "Geld",
    ["ma_Energy"] = "Energie",
    ["ma_Rage"] = "Wut",
    ["ma_Mana"] = "Mana",
    ["ma_Healthpoints"] = "Gesundheit",
    ["ma_Talents"] = "Talente",
    ["ma_Stats"] = "Stats",
    ["ma_Spells"] = "Spells",
    ["ma_Honor"] = "Ehre",
    ...
    ["Draenei"] = "Draeneiisch",
    ["ma_NoFavorites"] = "Es existieren keine Favouriten!",
    ...
    ["cmd_toggle"] = "Schalte das Hauptfenster um",
    ["cmd_transparency"] = "Schalte die Basistransparenz um (0.5 or 1.0)",
    ["cmd_tooltip"] = "Schalte Tooltips ein oder aus",
    ["tt_SkillButton"] = "Schalte ein Fenster ein zum F\195\164higkeitensuchen und um Favouriten zu verwalten.",
    ["tt_RotateLeft"] = "Drehe links.",
    ["tt_RotateRight"] = "Drehe rechts.",
    ["tt_FrmTrSlider"] = "\195\164ndere Fenster Transparenz.",
    ["tt_BtnTrSlider"] = "\195\164ndere Button Transparenz.",
    ["ma_SkillButton"] = "Skillsuche",
    ["ma_SkillVar1Button"] = "Skill",
    ["ma_SkillVar2Button"] = "Max Skill",
    ["tt_DisplayAccountLvl"] = "Zeigt den Account Level.",
    --linkifier
    ["lfer_Spawn"] = "Spawn",
    ["lfer_List"] = "Liste",
    ["lfer_Goto"] = "Goto",
    ["lfer_Move"] = "Bewege",
    ["lfer_Turn"] = "Turn",
    ["lfer_Delete"] = "L\195\182schen",
    ["lfer_Teleport"] = "Teleportieren",
    ["lfer_Morph"] = "Verwandeln",
    ["lfer_Add"] = "Hinzuf\195\188gen",
    ["lfer_Remove"] = "Entfernen",
    ["lfer_Learn"] = "Lernen",
    ["lfer_Unlearn"] = "Verlernen",
    ["lfer_Error"] = "Fehler Suchstring gefunden aber ein Fehler ist aufgetreten oder der Typ wurde nicht erkannt."
  } 
end
